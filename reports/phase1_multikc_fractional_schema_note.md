...
- KC update mode: `fractional_equal`
...
- KC increment per linked KC: `1 / kc_count per linked KC`
...
- Mean `kc_opportunity_mean` in test rows: `2.0112661241211316`
- Mean `practice_feature` in test rows: `1.4502945520799424`
